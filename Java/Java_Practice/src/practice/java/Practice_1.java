 ...
 *	ASUS-FL5800		15.6	4999.5		i7处理器4GB内存128G固态硬盘	18
 */
...
public class Practice_1 {
	public static void main(String[] args) {
		...
		// 计算总库存数（sumInventory）和库存总价（sumPrice）
		...
		System.out.println("库存总价是：" + sumPrice);
	}
}